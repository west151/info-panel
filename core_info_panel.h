...
private:
    ...
    process_model* ptr_process_model {Q_NULLPTR};
    ...
    ps_process_wokers* ptr_ps_process_wokers {Q_NULLPTR};
    QPointer<QThread> ptr_ps_process_thread;
